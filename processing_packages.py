    ...
    def get_recs(self, start_index, index_in_header):
        ...
        for i in range(self.header[index_in_header]):
            ...
            if record_type == 1:
                ...
                print("Name: " + str(domain), ", TTL: " + str(record_ttl), ", IP: " + str(domain_ip))
            elif record_type == 2:
                ...
                print("Name: " + str(domain), ", TTL: " + str(record_ttl), ", Server name: " + str(dns_name))
    ...
    def get_response(self, info):
        ...
        if self.question_type == 1:
            for record in info:
                ...
                question_and_answer = question_and_answer + offset + struct.pack(">HHIH",
                                                                                 record[1], 1,
        ...
        if self.question_type == 2:
            for record in info:
                ...
                question_and_answer = question_and_answer + offset + struct.pack(">HHIH", record[1], 1, record[2],
                                                                                 pack_name[1]) + pack_name[0]
